...
public class StanzaProtected {
	...
	protected Attrezzo[] attrezzi;		//Array di Attrezzi degli attrezzi contenuti
	protected int numeroAttrezzi;			//Intero di attrezzi nella stanza
	private StanzaProtected[] stanzeAdiacenti;	//Array delle stanze adiacenti
	...
	public StanzaProtected getStanzaAdiacente(String direzione) {
		StanzaProtected stanza = null;							//Dichiaro la stanza da ritornare
